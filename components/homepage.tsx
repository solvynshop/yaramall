...
import { ArrowLeft, Check, Clock3, CreditCard, Headphones, Package, ShieldCheck, Sparkles, Star, Truck, Zap } from 'lucide-react';
      ...
      <section className="relative bg-mesh">
        <div className="container mx-auto px-4 py-10 md:py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="relative z-10 max-w-2xl mx-auto lg:mx-0 text-center lg:text-right animate-fade-up">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                <Button size="lg" className="h-14 rounded-2xl px-8 text-base font-bold shadow-glow" asChild><Link href="/search">{t('hero.cta1')} <ArrowIcon className="mr-2 h-5 w-5" /></Link></Button>
              ...
              <div className="flex items-center justify-center lg:justify-start gap-6 mt-10">
                ...
                <div className="text-right">
                  <div className="flex items-center gap-1 text-primary justify-center lg:justify-start">{[1,2,3,4,5].map((s) => <Star key={s} className="h-3.5 w-3.5 fill-current" />)}</div>
          ...
          <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-primary/10 via-accent/5 to-muted p-8 md:p-14">
            <div className="grid md:grid-cols-2 items-center gap-8">
              <div className="max-w-lg mx-auto md:mx-0 text-center md:text-right">
                ...
                <Button variant="outline" className="rounded-xl font-bold" asChild><Link href="/search">{t('editorial.cta')} <ArrowIcon className="mr-2 h-4 w-4" /></Link></Button>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="relative overflow-hidden rounded-[2rem] bg-foreground p-8 md:p-14 text-center text-background">
            ...
            <div className="relative max-w-2xl mx-auto">
              ...
              <Button size="lg" className="rounded-xl px-8 font-bold" asChild><Link href="/search">{t('cta.btn')} <ArrowIcon className="mr-2 h-4 w-4" /></Link></Button>
            </div>
          </div>
        </div>
      </section>
